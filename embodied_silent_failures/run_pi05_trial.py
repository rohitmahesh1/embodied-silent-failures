...
from embodied_silent_failures.pi05_rollout import RolloutConfig, array_sha256, run_trial
...
def _arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run one pinned pi0.5 LIBERO trial.")
